...
INDEXED_PROMPT = (
    ...
    "\n"
    f"The question arrives separately, in a <{QUESTION_TAG}> block. Answer it only from the "
    "extracts. Never invent an employer, a date, a technology, or a qualification that is not "
    "present in them.\n"
    "\n"
